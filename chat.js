 ...
 */
define([
	'polyfills/es6-promise', // todo: should maybe be injected by default always somehow? or drop now since basically all "our" browser ok now?
	'jquery', // todo: drop. only $.extend is used now
	// 'blq',
	'blq/assert',
	'blq/xirsys',
	'blq/promise',
...
var chat = {
	...
	// id is optional, autogenerated (returns actual id)
